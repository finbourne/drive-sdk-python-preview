...
class RetryTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        lusid_drive.api.MockApi = MockApi
        cls.factory = ApiClientFactory(token="mock_token", drive_url="https://mock.url")
    ...
    def test_providing_retry_override_argument_success(self):
        ...
        with self.assertRaises(ApiException) as ex:
            api.execute_failing_retryable("Portfolio", name="Portfolio", lusid_drive_retries=10)
    ...
    def test_providing_retry_override_argument_not_int_uses_default(self):
        ...
        with self.assertRaises(ApiException) as ex:
            api.execute_failing_retryable("Portfolio", name="Portfolio", lusid_drive_retries="ThisWontWork")
    ...
    def test_providing_retry_override_with_no_retry_invokes_call(self):
        ...
        api.execute_retryable_call("Portfolio", name="Portfolio", lusid_drive_retries=0)
